...
`DFP_CREATIVE_FORMAT` | The format for creative name. | `'{bidder_code}: HB {order_name}, #{num}'`
`DFP_ENABLE_CREATIVE_SAFEFRAME` | Enable or disable creatives serve into a safeframe. | `True`
